package com.company.nedbankhr20.viewmodel.supplier
 ...
 */
class SupplierViewModel(application: Application): EntityViewModel<Supplier>(application, EntitySets.suppliers, Supplier.city) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<Supplier>(application, EntitySets.suppliers, Supplier.city, navigationPropertyName, entityData)
    }
}
