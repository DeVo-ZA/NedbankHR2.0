package com.company.nedbankhr20.viewmodel.producttext
 ...
 */
class ProductTextViewModel(application: Application): EntityViewModel<ProductText>(application, EntitySets.productTexts, ProductText.language) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<ProductText>(application, EntitySets.productTexts, ProductText.language, navigationPropertyName, entityData)
    }
}
