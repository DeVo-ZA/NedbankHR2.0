package com.company.nedbankhr20.viewmodel.purchaseorderitem
 ...
 */
class PurchaseOrderItemViewModel(application: Application): EntityViewModel<PurchaseOrderItem>(application, EntitySets.purchaseOrderItems, PurchaseOrderItem.currencyCode) {
    /**
    ...
    constructor(application: Application, navigationPropertyName: String, entityData: Parcelable): this(application) {
        EntityViewModel<PurchaseOrderItem>(application, EntitySets.purchaseOrderItems, PurchaseOrderItem.currencyCode, navigationPropertyName, entityData)
    }
}
