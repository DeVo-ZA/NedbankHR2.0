package com.company.nedbankhr20.repository

import androidx.lifecycle.MutableLiveData

import com.company.nedbankhr20.archcomp.SingleLiveEvent
import com.company.nedbankhr20.mediaresource.EntityMediaResource
import com.company.nedbankhr20.repository.OperationResult.Operation
...
class Repository<T : EntityValue>(
    ...
    init {
        ...
        if (EntityMediaResource.isV4(eSPMContainer.metadata.versionCode) && EntityMediaResource.hasMediaResources(entitySet)) {
